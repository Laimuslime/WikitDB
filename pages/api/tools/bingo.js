...
export default async function handler(req, res) {
    if (req.method === 'GET') {
        try {
            ...
            if (!config) config = { tags: ['原创', '翻译', '搞笑', '微恐', '设定中心', '人事档案'], cost: 50 };
    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            return res.status(200).json({ success: true, article, hitCount, reward, newBalance: user.balance });
