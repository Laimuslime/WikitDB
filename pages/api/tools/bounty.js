...
export default async function handler(req, res) {
    if (req.method === 'GET') {
        ...
        try {
            ...
            } else if (typeof bounties === 'string') bounties = JSON.parse(bounties);
    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            return res.status(200).json({ success: true, article, reward: bounty.reward, newBalance: user.balance, bounties });
